...
Diabetes_model = pickle.load(open('MODEL1.sav', 'rb'))

Heart_Disease_model = pickle.load(open('MODEL2.sav', 'rb'))

Liver_Disease_model = pickle.load(open('MODEL4.sav', 'rb'))

Parkinsons_model = pickle.load(open('MODEL3.sav', 'rb'))
